...
async fn main() {
    ...
    let app = axum::Router::new()
        ...
        .route("/tags", axum::routing::get(views::tag::get_all_tags))
        .route("/types", axum::routing::get(views::r#type::get_all_types))
        .route("/people", axum::routing::get(views::person::get_all_people))
